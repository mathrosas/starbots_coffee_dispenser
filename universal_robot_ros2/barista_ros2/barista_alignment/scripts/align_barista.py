...
class Aligner(Node):
    def __init__(self):
        ...
        self.action_server_name = self.robot_name + '/align_barista'
        self._action_server = ActionServer(self, AlignBarista, self.action_server_name, self.align, callback_group=self.callback_group)
