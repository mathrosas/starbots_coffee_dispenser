...
def generate_launch_description():
    ...
    # models_pkg_path = "/home/user/ros2_ws/src/universal_robot_ros2/barista_ros2"
    models_pkg_path = os.path.dirname(get_package_share_directory('barista_description'))

    if 'GAZEBO_MODEL_PATH' in os.environ:
        os.environ['GAZEBO_MODEL_PATH'] =  os.environ['GAZEBO_MODEL_PATH'] + ':' + models_pkg_path
    else:
        os.environ['GAZEBO_MODEL_PATH'] =  models_pkg_path
